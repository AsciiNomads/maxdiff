...
"")
        ...
        sizePolicy1.setHeightForWidth(self.formWidget_2.sizePolicy().hasHeightForWidth())
        self.formWidget_2.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.plot_pic.sizePolicy().hasHeightForWidth())
        self.plot_pic.setSizePolicy(sizePolicy2)
        self.plot_pic.setMinimumSize(QSize(1500, 400))
        self.plot_pic.setMaximumSize(QSize(1500, 16777215))
